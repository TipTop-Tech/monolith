...
export function ActiveWorkout() {
  ...
  const currentRoutineExercise = currentRoutine?.exercises[currentExerciseIndex] ?? null;
                ...
                return (
                  ...
                  >
                    <div className="text-left">
                      ...
                      {routineExercise.coachNotes ? (
                        <div className="mt-2 max-w-[18rem] text-xs leading-4 text-muted-foreground/70">
                          {routineExercise.coachNotes}
                        </div>
                      ) : null}
                    </div>
      ...
      <div className="h-full flex flex-col min-h-0">
        ...
        <div className="px-4 sm:px-6 pt-4 sm:pt-8 pb-3 sm:pb-6 overflow-x-auto">
          ...
          <div className="flex flex-col items-center justify-center px-4 sm:px-6 py-[60px] sm:py-5 shrink-0">
            ...
            {currentRoutineExercise?.suggestedWeightLbs ? (
              <div className="label-font text-[10px] tracking-[0.22em] text-muted-foreground/80 mt-3">
                AI START ≈ {currentRoutineExercise.suggestedWeightLbs} LBS
              </div>
            ) : null}
