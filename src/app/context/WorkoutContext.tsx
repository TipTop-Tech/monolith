...
const SAMPLE_EXERCISES: Exercise[] = [
  ...
  { id: "3", name: "Deadlift", muscleGroups: ["upper-back", "lower-back", "gluteal", "hamstring"] },
  ...
  { id: "7", name: "Pull-ups", muscleGroups: ["upper-back", "biceps", "back-deltoids"] },
  { id: "8", name: "Leg Press", muscleGroups: ["quadriceps", "gluteal"] },
  { id: "9", name: "Lat Pulldown", muscleGroups: ["lats", "upper-back", "biceps"] },
  ...
  { id: "13", name: "Lateral Raises", muscleGroups: ["back-deltoids", "trapezius"] },
  { id: "14", name: "Front Raises", muscleGroups: ["front-deltoids"] },
  { id: "15", name: "Rear Delt Fly", muscleGroups: ["back-deltoids", "upper-back"] },
  ...
  { id: "22", name: "Barbell Rows", muscleGroups: ["upper-back", "biceps", "trapezius"] },
  { id: "23", name: "T-Bar Rows", muscleGroups: ["upper-back", "trapezius"] },
  { id: "24", name: "Seated Cable Rows", muscleGroups: ["upper-back", "biceps", "back-deltoids"] },
  { id: "25", name: "Face Pulls", muscleGroups: ["back-deltoids", "trapezius"] },
  { id: "26", name: "Shrugs", muscleGroups: ["trapezius"] },
  ...
  { id: "46", name: "Upright Rows", muscleGroups: ["trapezius", "back-deltoids"] },
  ...
  { id: "55", name: "Farmer's Carry", muscleGroups: ["forearm", "trapezius"] },
  ...
  { id: "59", name: "Scapular Retractions", muscleGroups: ["upper-back", "trapezius"] },
  { id: "60", name: "Reverse Fly", muscleGroups: ["back-deltoids", "upper-back"] },
